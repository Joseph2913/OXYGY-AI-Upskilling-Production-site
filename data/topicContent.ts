...
const L1T1_SLIDES: SlideData[] = [
  ...
  { section: "THE REALITY", type: "evidenceHero",
    ...
    stats: [{ value: "75%", valueColour: "#2B6CB0", label: "of knowledge workers now use AI at work", source: "Microsoft & LinkedIn", desc: "2024 Work Trend Index", visualType: "dotGrid" }],
...
const L4T1_SLIDES: SlideData[] = [
  ...
  {
    section: "THE REALITY", type: "concept",
    takeaway: "Vibe coding means directing AI in plain language until it builds what you described — no technical skills required",
  ...
  {
    section: "SEE THE DIFFERENCE", type: "comparison",
    ...
    scenario: "Two teams tackle the same tool idea: a project status dashboard for leadership. One writes a brief. The other doesn't. Toggle to compare what each produces.",
    tabs: [
      {
  ...
  {
    section: "IN PRACTICE", type: "dragSort",
    takeaway: "Apply the Brief Readiness Framework: sort each brief statement by readiness level",
    heading: "Sort these brief statements by readiness level.",
    tealWord: "Sort",
    dragContext: "You're reviewing briefs before they go to the builder. Drag each statement into the correct readiness level based on the Brief Readiness Framework.",
    dragZones: [
      { id: "strong", label: "STRONG", color: "#48BB78", light: "#F0FFF4", icon: "✅" },
      { id: "partial", label: "PARTIAL", color: "#ED8936", light: "#FFFBEB", icon: "⚠️" },
      { id: "not-ready", label: "NOT READY", color: "#FC8181", light: "#FFF5F5", icon: "❌" },
    ],
    dragItems: [
      { id: "i1", label: "Build a tool for the finance team.", correctZone: "not-ready" },
      { id: "i2", label: "Give the CFO a Friday end-of-week view of at-risk projects — flagged items from the tracker spreadsheet, exported weekly.", correctZone: "strong" },
      { id: "i3", label: "A dashboard for the Head of Operations — she checks it Monday mornings and needs clear action items before the standup.", correctZone: "partial" },
      { id: "i4", label: "Input: weekly CSV export from the project tracker. AI step: classify risk level. Output: traffic-light status + one recommended action per project.", correctZone: "strong" },
...
const L4T1_VIDEOS: VideoData[] = [
  ...
  {
    id: "v2",
    title: "Best AI App Builder to Make Software in Minutes",
    channel: "Aurelius Tjin",
    duration: "5:24",
    desc: "A quick comparison of the top no-code AI app builders, showing how each turns a plain-language brief into a working application. Directly relevant to Level 4's focus on choosing the right platform and understanding what each builder does well — and where it falls short.",
    url: "https://www.youtube.com/watch?v=XUITNz8EJO0",
    quiz: [
      {
        q: "What does the video identify as the most important factor when choosing an AI app builder?",
        options: [
          "The number of templates it offers",
          "How well it matches the type of application you are building",
          "Whether it has a free tier",
          "How many programming languages it supports",
        ],
        correct: 1,
      },
      {
        q: "According to the video, what is a key limitation shared by most no-code AI builders?",
        options: [
          "They cannot connect to external APIs",
          "They only work on desktop browsers",
          "Complex customisation often requires workarounds or upgrading to a paid plan",
  ...
  {
    id: "v3",
    title: "How to Make An App For Your Business (NO Code Needed!)",
    channel: "Kevin Stratvert",
    duration: "15:18",
    desc: "A step-by-step walkthrough of building a business application without writing code — from defining the use case to configuring user roles and deploying. Covers the end-to-end process that mirrors the PRD-to-prototype pipeline in this level.",
    url: "https://www.youtube.com/watch?v=fR4L_tipTHY",
    quiz: [
      {
        q: "What does the video recommend as the first step before opening any app builder?",
        options: [
          "Choosing a colour scheme and layout",
          "Clearly defining who will use the app and what problem it solves",
      ...
      {
        q: "The video demonstrates adding user roles to the app. Why is this step important?",
        options: [
          "It makes the app load faster",
          "It ensures different users see only the data and actions relevant to them",
          "It is required by all no-code platforms before publishing",
          "It reduces the cost of hosting the application",
        ],
        correct: 1,
      },
    ],
...
const L5T1_VIDEOS: VideoData[] = [
  {
    ...
    channel: "AI Engineer",
    duration: "17:06",
    desc: "A practical framework for building AI applications that work reliably in production. Covers the twelve design patterns — from owning your prompts and treating tools as first-class citizens to building for human-in-the-loop oversight — that separate fragile demos from dependable systems.",
    url: "https://www.youtube.com/watch?v=8kMaTybvDUw",
    quiz: [
      {
        q: "According to the 12-factor framework, why should you 'own your prompts' rather than relying on a platform's defaults?",
        options: [
          "Default prompts are too short for complex tasks",
          "Owning prompts gives you control over behaviour, debugging, and iteration — platform defaults change without notice",
          "It reduces API costs by using fewer tokens",
          "Platform prompts are not compatible with open-source models",
        ],
        correct: 1,
      },
      {
        q: "What does the video identify as the key benefit of building AI apps with human-in-the-loop oversight?",
        options: [
          "It eliminates the need for automated testing",
          "It allows the system to catch and correct errors before they reach end users",
  ...
  {
    id: "v3",
    title: "Vibe Coding an Educational Search Tool with Gemini 3",
    channel: "Google for Developers",
    duration: "1:48",
    desc: "A rapid end-to-end demo of building a functional AI-powered search tool using natural language prompts. Shows the full cycle from idea to working prototype in under two minutes — a concrete example of the build pipeline covered in this level.",
    url: "https://www.youtube.com/watch?v=8VsZLFAk54o",
    quiz: [
      {
        q: "What approach does the video demonstrate for building the search tool?",
        options: [
          "Writing code line-by-line in a traditional IDE",
          "Describing the desired behaviour in natural language and letting AI generate the implementation",
          "Copying and pasting code from a template repository",
          "Using a drag-and-drop visual builder",
        ],
        correct: 1,
      },
      {
        q: "What does this demo illustrate about the relationship between brief quality and output quality?",
        options: [
          "The AI produces the same result regardless of how the brief is written",
          "A clear, specific brief leads to a more accurate and useful tool",
          "Longer briefs always produce better results",
          "The AI ignores the brief and generates a random output",
        ],
        correct: 1,
      },
    ],
